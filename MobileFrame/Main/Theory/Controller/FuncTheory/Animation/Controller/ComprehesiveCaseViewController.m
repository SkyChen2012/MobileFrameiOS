//
//  ComprehesiveCaseViewController.m
//  MobileFrame
//
...
@interface ComprehesiveCaseViewController ()<DCPathButtonDelegate>
...
@implementation ComprehesiveCaseViewController
...
-(void)clickGoodAnimation{
    ...
    if (!_goodBtn) {
        _goodBtn = [[MCFireworksButton alloc] initWithFrame:CGRectMake(Main_Screen_Width/2-25, Main_Screen_Width/2-25, 50, 50)];
